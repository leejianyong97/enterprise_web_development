...
<nav class="navbar navbar-light fixed-top bg-primary" style="padding:0;min-height: 3.5rem">
  <div class="container-fluid mt-2 mb-2">
      ...
      <div class="col-md-4 float-left text-white">
        <large><b>Welcome to University of Greenwich Quality Assurance</b></large>
      </div>
...
<script>
  $('#manage_my_account').click(function(){
    uni_modal("Manage Account","cw_user_manage.php?id=<?php echo $_SESSION['login_id'] ?>&mtype=own")
  })
