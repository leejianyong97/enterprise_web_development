...
<head>
	...
	<main id="content" role="main" class="main">
		...
		<a class="d-flex justify-content-center mb-5" href="./index.html">
			<img class="zi-2" src="./assets/img/logos/main-logo.jpg" alt="Image Description" style="width: 8rem;">
		</a>
		...
		<div class="mx-auto" style="max-width: 30rem;">
			...
			<div class="card-body">
				...
				<!-- Form -->
				<div class="mb-4">
					<label class="form-label" for="signinUsername">Your username</label>
					<input type="text" class="form-control form-control-lg" name="username" id="signinUsername" tabindex="1" placeholder="username" aria-label="username" required>
