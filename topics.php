			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<a class="navbar-brand">New Idea</a>
						<span class="">

							<a class="navbar-brand" href="informpage.php">Notifications</a>
							<button class="btn btn-primary btn-block btn-sm col-sm-2 float-right" type="button" id="new_topic">
					<i class="fa fa-plus"></i> Create New Idea</button>
				</span>
					</div>
					<div class="card-body">
...
<script>
	...
	$('#new_topic').click(function(){
		uni_modal("New Entry","cw_topic_manage.php",'mid-large')
	})
